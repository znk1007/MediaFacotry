...
- (void)setModel:(MediaPhotoModel *)model
{
    ...
    } else if (model.type == MediaAssetMediaTypeGif) {
        self.videoBottomView.hidden = !self.allSelectGif;
        self.videoImageView.hidden = YES;
        self.liveImageView.hidden = YES;
        self.timeLabel.text = @"GIF";
    } else if (model.type == MediaAssetMediaTypeLivePhoto) {
    ...
    self.imageRequestID = [MediaPhotoManager requestImageForAsset:model.asset size:size completion:^(UIImage *image, NSDictionary *info) {
